...
<acme:form>
	<acme:input-textarea code="authenticated.company.form.label.name" path="name"/>
	<acme:input-textarea code="authenticated.company.form.label.vat-number" path="vatNumber"/>
