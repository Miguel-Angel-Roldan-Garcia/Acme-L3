...
<acme:list>
	...
	<acme:list-column code="assistant.tutorial-session.list.label.nature" path="nature" width="20%"/>
	<acme:list-column code="assistant.tutorial-session.list.label.start-date" path="startDate" width="20%"/>
</acme:list>
